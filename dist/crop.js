/*!
 * crop.js v0.0.2
 * git+https://github.com/94cstyles/crop.git
 * License: MIT
 * Date: 2017-5-4 10:23
 */
...
var animationEnd = function (el, callback) {
    var aniTime = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
            ...
            if (!_this3.file.busy) {
                if (e.target.files) {
                    ...
                    if (e.target.files[0].type === '' || /image\/(jpeg|png|gif|bmp|tiff)/.test(e.target.files[0].type)) {
                        _this3.first = true;
                        _this3.trigger('change', e.target.files[0]);
